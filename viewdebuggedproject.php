...
<h1 style="font-size:60px;">Debugged Projects</h1>
...
if($con)
{
	$q="select * from uploaddebuggedproject";
...
<p><a href="finalizedproject.html">Finalize any of the above project?</a></p><td><td>
